...
source("C:\\Users\\Angel\\Desktop\\GNLPDA\\RESULTADOS JUNIO\\RESULTADOS DE CALIBRACIÓN\\KFDA MANUAL.R")
...
ruta_resultados  <- "C:\\Users\\Angel\\Desktop\\GNLPDA\\RESULTADOS JUNIO\\RESULTADOS DE CALIBRACIÓN\\RESULTADOS_KFDA/"
...
#### Aislar a corridas individuales ####
...
grid_sigma <- sigma_base * c(0.0001)
#c(0.0001, 0.001, 0.005, 0.01, 0.025, 0.05, 
...
# Extracción de métricas adaptada estructuralmente (Mantenimiento de Simetría)
...
for (archivo in archivos_csv) {
  ...
  df_res_instancia <- do.call(rbind, resultados_lista);df_res_instancia
