...
# ==============================================================================
# FRAMEWORK SVM POLINOMIAL (GRADO 3) PARALELIZADO CON EL ENFOQUE FUTURE (R)
# ==============================================================================
...
ruta_resultados  <- "C:\\Users\\Angel\\Desktop\\GNLPDA\\RESULTADOS JUNIO\\RESULTADOS DE CALIBRACIÓN\\RESULTADOS_SVM_POLY3/"
...
for (archivo in archivos_csv) {
  ...
  cat("\n==================================================================\n")
  cat("Iniciando Fine-Tuning SVM (Poly G3) para:", nombre_base, "\n")
  cat("==================================================================\n")
  ...
  resultados_lista <- future_lapply(1:n_corridas, function(run) {
    ...
    modelo_final         <- e1071::svm(x = X_train_run, y = y_train_run, 
                                       kernel = "polynomial", degree = 3, coef0 = 1,
                                       cost = c_optimo, gamma = gamma_optimo)
    ...
    #### Reportar los resultados conforme salgan ###
  ...
  write.csv(df_res_instancia, 
            file = file.path(ruta_resultados, paste0(nombre_base, "_res_svm_poly3.csv")), 
            row.names = FALSE)
