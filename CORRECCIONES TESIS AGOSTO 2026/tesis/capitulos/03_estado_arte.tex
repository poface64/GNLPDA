...
Frente a estas limitaciones, el Análisis Discriminante Polinomial No Lineal Genético (GNLPDA) se posiciona como una alternativa metodológica orientada a la integración de selección evolutiva, modelado no lineal explícito, proyección discriminante de baja dimensión, trazabilidad de las características utilizadas, en escenarios de alta dimensionalidad y problemas de muestras pequeñas (SSS). En este sentido, GNLPDA retoma la lógica evolutiva presente en GPDA, al formular la búsqueda de proyecciones como un problema de optimización \cite{medina2025genetic}, pero introduce una expansión polinomial explícita que permite representar interacciones entre variables sin recurrir necesariamente a un mapeo kernel implícito basado en matrices de Gram.

El aporte central de GNLPDA radica en la incorporación del manejo de la no linealidad mediante términos polinomiales definidos sobre las variables originales. A diferencia de los métodos kernel, donde el mapeo al espacio de características suele operar de manera implícita, esta formulación permite conservar una relación más directa entre los predictores iniciales, sus interacciones y la proyección discriminativa resultante.  Por ello, el método busca equilibrar la capacidad de modelar fronteras de decisión no lineales con una mayor trazabilidad analítica de las características utilizadas.

En este sentido, GNLPDA se plantea como una formulación que integra, dentro de un mismo procedimiento, la selección evolutiva de características, la representación explícita de relaciones no lineales y la obtención de proyecciones discriminantes de baja dimensión. Esta integración permite abordar conjuntamente aspectos que en los métodos revisados se presentan de manera parcial o mediante mecanismos distintos, particularmente la reducción del espacio de características, la representación visualizable de la estructura discriminante y la trazabilidad respecto de las variables y términos polinomiales seleccionados. Su evaluación experimental se orienta, por tanto, a analizar estas propiedades en conjunto con el desempeño predictivo, la estabilidad y el costo computacional, frente a métodos lineales y basados en kernel.
